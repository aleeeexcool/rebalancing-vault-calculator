...
class FundParameters:
    def __init__(self, total_borrowed1, total_supplied1, optimal_usage_ratio1, 
                 ...
                 rewards_per_year1=0, rewards_per_year2=0, rewards_per_year3=0):
        self.fund1 = {
...
def calculate_distribution(total_supply, params):
    ...
    def objective(vars):
        x, y, z = vars
        value = x * f_pool1(x, params) + y * f_pool2(y, params) + z * f_pool3(z, params)
        return -value  # NEGATE to perform maximization
    ...
    # Bounds: x, y, z ≥ 0
    bounds = [(0, total_supply)] * 3

    # Initial guess (equally distributed)
    initial_guess = [total_supply / 3] * 3
