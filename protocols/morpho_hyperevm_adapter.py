"""
Morpho Protocol Adapter for HyperEVM network
"""
import json
import logging
import requests
...
class MorphoHyperEvmAdapter(BaseProtocolAdapter):
    """
    Adapter for Morpho protocol on HyperEVM network
    """
    
    SOURCE = "Morpho HyperEVM"
    ...
    async def get_market_by_unique_key_optimized(cls, unique_key):
        ...
        try:
            ...
            # Update source to Morpho HyperEVM for this adapter
            market_data["source"] = "Morpho HyperEVM"
            ...
            if cache_misses:
                ...
                for market_data in markets:
                    ...
                    if market_id in cache_misses:
                        # Update source to Morpho HyperEVM
                        market_data["source"] = "Morpho HyperEVM"
    ...
    def calculate_reserve_apy(cls, our_supply, reserve_data):
        ...
        try:
            ...
            #     logging.info(f"[Morpho HyperEVM] rewards: yearly_supply_tokens={yearly_supply_tokens}, reward_price={reward_price}, asset_price={asset_price}, reward_value={reward_value}, total_supply_value={total_supply_value}, rewards_apr={rewards_apr}, rewards_apy={rewards_apy}")
