...
class LendleMantleIsolatedAdapter(BaseProtocolAdapter):
    """
    Adapter for Lendle protocol V3 on Mantle network
    This version receives aToken address and extracts underlying token address
    """
    SOURCE = "Lendle Isolated Mantle"
    ...
    def _load_isolated_markets_data(cls):
        ...
        try:
            current_dir = os.path.dirname(os.path.abspath(__file__))
            json_path = os.path.join(current_dir, 'lendle-isolated-markets.json')
